  ...
  return (
    <ThemeProvider theme={darkTheme}>
      ...
      <Container maxWidth='lg'>
        ...
        <blockquote>
          <p>
            L'esecuzione da codice sorgente è consigliabile solo per utenti che
            conoscono Java, Maven, Node.js e NPM.
          </p>
        </blockquote>
        <p>
          Un modo per utilizzare l'ambiente è quello di eseguire gli script
          utilizzati per provare il programma durante la fase di sviluppo.
          Questa modalità però non permette di simulare un ambiente reale con
          tutte le ottimizzazioni che i framework usano dopo aver eseguito il
          "build". Il programma si divide in due parti: analizzatore (back-end)
          e interfaccia (front-end).
        </p>
        <blockquote>
          <p>
        ...
        <blockquote>
          <p>
            Per il back-end è prima necessario avere installato Maven e Java JDK
            sul proprio PC.
          </p>
        </blockquote>
        <p>
          Il back-end sfrutta la grammatica MALT per poter analizzare il codice.
          Per questo motivo bisogna prima installare <em>malt.jar</em> come
          repository Maven globale nel proprio PC.
        </p>
        <p>
          Per fare ciò basta entrare nella cartella "malt_backend" ed eseguire
          il file <em>script.bat</em> se si sta utilizzando Windows oppure il
          file{' '}
          <em>
            <a href='http://script.sh'>script.sh</a>
          </em>{' '}
          nel caso si stia utilizzando Linux.
        </p>
        <p>
          Una volta installata la dipendenza, sempre nella cartella
          "malt_backend", è possibile eseguire il comando per avviare il
          back-end
        </p>
        <pre>
        ...
        <p>
          Verrà lanciato un server realizzato con Spring disponibile alla porta
          8000.
        </p>
        <p>
          Per lanciare l'interfaccia invece basta entrare nella cartella
          "malt_frontend" ed installare le dipendenze necessarie (solo la prima
          volta) con il comando
        </p>
        <pre>
          <code className='language-shell'>npm install{'\n'}</code>
        </pre>
        <p>e successivamente eseguire il server con il comando</p>
        <pre>
        ...
        <p>
          ...
          pulsante <em>MALT</em> della barra di navigazione in cima alla pagina.
          Per procedere con l'esecuzione concreta del parser e/o dello scanner,
          si può cliccare sul pulsante nella barra di navigazione in cima alla
          pagina oppure su quello in fondo alla pagina stessa entrambi
          denominati <em>EDITOR</em>.
        </p>
        <p>
          <img
            src='guide_images/localhost_3000_.png'
        ...
        <p>
          ...
          cliccando sul pulsante <em>ESEGUI PARSER</em> oppure può eseguire il
          scanner cliccando sul pulsante <em>ESEGUI SCANNER</em>.
        </p>
        <p>
          <img
            src='guide_images/localhost_3000_editor.png'
        ...
        <p>
          <img
            src='guide_images/localhost_3000_editor_parser.png'
        ...
        <p>
          <img
            src='guide_images/localhost_3000_editor_scanner.png'
        ...
        <p>
          <img
            src='guide_images/localhost_3000_guide.png'
